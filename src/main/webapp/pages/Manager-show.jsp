                ...
                <!--树表格-->
                        <div class="tab-pane" id="tab-treetable">
                            <table id="collapse-table" class="table table-bordered table-hover dataTable">
                                ...
                                <tr data-tt-id="0"  >
                                    <td colspan="4">${manager.managerName}</td>
                                </tr>
                                <tbody>
                                <c:forEach items="${manager.roles}" var="p" varStatus="vs">
                                <tr data-tt-id="${vs.index+1}" data-tt-parent-id="0">
                                    <td> 用户权限 </td>
                                    <td>${p.rolePermission}</td>
                                    <td> <button id="btn" class="btn bg-olive btn-xs">详情</button></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
